...
import com.cmsystem.wms.validate.Mobile;
import com.cmsystem.wms.validate.Password;
import com.cmsystem.wms.validate.RealName;
import com.cmsystem.wms.validate.UserName;
...
@Repository
@ApiModel(value = "UserInfo", description = "用户模型")
public class UserInfo extends SerializeBase {
     ...
     * @return
     */
    public UserInfo hiddenSecurity() {
        password = null;
        token = null;
        return this;
    }
