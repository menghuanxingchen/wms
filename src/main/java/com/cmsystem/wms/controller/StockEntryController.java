...
import com.cmsystem.wms.form.StockEntryDeliveryFinishForm;
import com.cmsystem.wms.mapper.DeliveryMapper;
import com.cmsystem.wms.mapper.StockEntryMapper;
import com.cmsystem.wms.model.StockEntry;
import com.cmsystem.wms.service.NumberCreateService;
import com.cmsystem.wms.service.StockEntryService;
import com.cmsystem.wms.util.StringUtil;
...
public class StockEntryController extends BaseController {
    ...
    Result insert(@Validated @RequestBody StockEntry stockEntry, BindingResult result) {
        ...
        stockEntry.setCreateUidToLoginUser(userInfoService);
    ...
    Result update(@Validated({ValidClass.EditForm.class, Default.class}) @RequestBody StockEntry stockEntry, BindingResult result) {
        ...
        stockEntry.setUpdateUidToLoginUser(userInfoService);
