...
import com.cmsystem.wms.mapper.InventoryMapper;
import com.cmsystem.wms.mapper.MoveMapper;
import com.cmsystem.wms.mapper.StockEntryMapper;
import com.cmsystem.wms.mapper.StockTransMapper;
import com.cmsystem.wms.model.Inventory;
import com.cmsystem.wms.model.Move;
...
public class MoveService extends BaseService {
    ...
    public Move insertMove(Move move) {
        ...
        move.setCreateUidToLoginUser(userInfoService);
    ...
    public Move updateMove(Move move) {
        Inventory inventory = inventoryService.saveInventoryByMove(move);
        move.setUpdateUidToLoginUser(userInfoService);
        move.setInventoryId(inventory.getId());
