package com.cmsystem.wms.entity;

import com.alibaba.fastjson.JSONObject;
import com.cmsystem.wms.mapper.UserInfoMapper;
import com.cmsystem.wms.model.UserInfo;
import com.cmsystem.wms.util.AESUtil;
import com.cmsystem.wms.util.BeanUtil;
...
public class Token {
    ...
    public UserInfo findUser() {
        UserInfoMapper userInfoMapper = BeanUtil.getBean(UserInfoMapper.class);
